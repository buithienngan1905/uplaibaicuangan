...
function thanhtoan() {
	alert('Mimish chân thành cảm ơn bạn vì đã lựa chọn chúng tôi! Nhân viên Mimish sẽ sớm liên lạc xác nhận và giao hàng ngay sau đó đối với đơn hàng của bạn - đội ngũ Mimish Việt Nam.')
}
